...
navToggle.addEventListener('click',function (){
  document.querySelector('.navbar__list').classList.toggle('show');
})

const hideNav = document.querySelector('.cmn');
hideNav.addEventListener('click',function (){
  document.querySelector('.navbar__list').classList.remove('show');
})
...
const hideNav6 = document.querySelector('.cmn6');
hideNav6.addEventListener('click',function (){
  document.querySelector('.navbar__list').classList.remove('show');
})
